            ...
            <main className="appear">
                <section id="experiecia" className="split-big-title">
                    ...
                    <div className="description-container">
                        <IntersectionContainer from={{ opacity: '0', transform: 'translateY(40px)' }} to={{ opacity: '1', transform: 'translateY(0px)' }} transitionTime={1000}>
                            <div>
